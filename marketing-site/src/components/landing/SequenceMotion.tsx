...
// The scrubbed-scroll controller for the pinned sequence (LINA-89).
//
 ...
 *
 * Only this one handoff is special (the founder chose a stage-1 re-render on a
 * matched camera; a cross-fade between the current stills reads as a glitch).
 * With `STAGE_1_TO_2 === 'cut'` the two stills never share the screen: stage 1
 * holds until the commit (KF B, t = 0.5) and then stage 2 takes over instantly.
 * 2 → 3 and 3 → 4 are camera dissolves and always stay blends. When the
 * designer's re-render lands, flipping the flag to `crossfade` is the whole
 * change.
 */
