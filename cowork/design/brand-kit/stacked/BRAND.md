# LinkNMS Stacked — Brand Guidelines
...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#2a78d6` | Gradient start, CTA, accents |
| Secondary | `#eb6834` | Gradient end, hover states |
| Text (light bg) | `#fcfcfb` | Body text on white/light |
| Text (dark bg) | `#0b0b0b` | Body text on dark |
| Background (light) | `#fcfcfb` | Light mode |
| Background (dark) | `#0b0b0b` | Dark mode |
