...
//
// Sessions carry a party UUID (see ./session.mjs); something has to turn a
// real-world identifier — in R0, an email — into that UUID. That mapping is
// Identity's to own (the table comment calls it "the authoritative mapping"),
// so it lives here rather than in a route handler.
//
