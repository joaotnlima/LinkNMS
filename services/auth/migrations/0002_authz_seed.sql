...
INSERT INTO authz.role_permissions (role_id, permission_id) VALUES
  ('20000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000002'), -- project.read (SCOPED — can() F1 predicate, dormant in v1; ADR-0010)
  ...
  ('20000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000016'), -- progress.report (SCOPED to assigned stages — can() F1 predicate; ADR-0010)
